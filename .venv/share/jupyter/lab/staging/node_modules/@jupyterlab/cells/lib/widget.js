...
class Cell extends widgets_1.Widget {
    ...
    constructor(options) {
        ...
        let inputCollapser = (this._inputCollapser = new collapser_1.InputCollapser());
...
class CodeCell extends Cell {
    ...
    constructor(options) {
        ...
        let outputCollapser = (this._outputCollapser = new collapser_1.OutputCollapser());
...
(function (CodeCell) {
    ...
    function execute(cell, session) {
        ...
        cell.setPrompt('*');
        model.trusted = true;
        return outputarea_1.OutputArea.execute(code, cell.outputArea, session)
            .then(msg => {
